...
exports.sendConfirmationEmail = function({toUser, hash}) {
    // construction du message à envoyer à l'utilisateur
  ...
  const message = {
    ...
    html: `
      ...
      <p>To activate your account please follow this link: <a target="_" href="${process.env.DOMAIN}/reset-password/${hash}">Reset Password Link</a></p>
      <p>Cheers</p>
